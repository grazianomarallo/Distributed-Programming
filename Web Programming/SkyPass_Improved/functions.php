...
/** GETTER AND UPDATER */
/*
 * This function retrieve all the row for the user passed and then it is
 * used to get the total number of ticket purchased and hold by the user
 */
...
/*
 * This function retrieve all the row for the user that has received the gift
...
function getTotalGiftDone($user){
    global $connection;
    $empty =0;
    $query = "SELECT * FROM gift WHERE gifter='$user' FOR UPDATE";
    if (mysqli_num_rows ( queryMysql ( $query ) ) == 0)
        return $empty;
    $result = queryMysql ( $query );
    $result = mysqli_fetch_array ( $result, MYSQLI_ASSOC );
...
/*
 * This function retrieve all the user from the table and then it's used
 * in order to have the list of user for choosing who is the one that
 * is receving the gift
 */
function getUsers(){
    global $connection;
    $empty =0;
...
/*
 * This function is used to update the total ticket hold by a user
 */
...
/*
 * This function is used to update the number of ticket that have been gifted from another
 * user.
 */
...
/*
 * This function check if the user which have to receive a gift
 *  exist in the table and return a boolean
 */
function checkUserExistenceGift($user){
    global $connection;
...
/*
 * This function check if the user exist in the table and if he has already purchased
 * some tickets, if no tickets are hold by the user a new table is inserted with ticket
 * set to 0. This is useful if someone gift a user before that he purchased a ticket by
 * himself
 */
 ...
 */
/*
 * This function allows to buy a new ticket or update the current status of the ticket
 * if the table is already present
 */
...
/*
 * This function allows to purchase a ticket for another user. Same strategy used for the above method
 */
...
/*
 * This function allows to view the total ticket earned by the user and also the number of tickets
...
/*
 * This function allows to view the number of ticket that have been gifted and who is the user
 * that have performed the gift
 */
