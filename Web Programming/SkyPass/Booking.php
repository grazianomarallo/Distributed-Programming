...
if (isset($_POST['post']) && isset($_POST['ticket'])) {
    ...
    if ((is_numeric($ticket) == true && $ticket >0 && strrpos($ticket,".") == false && strrpos($ticket,",") == false)){
         ...
         */
            ...
            else  $mess="The gift cannot be done bacause limit is overwhelmed";
    ...
    /*
     * Case 4: User request number of ticket over the maximum allowed
     * so the booking is not performed and user is advertised
     */
    else if ($ticket >=10){
        //todo here has to be checked without js
        $mess="You cannot buy more than 10 tickets for policy reasons.";
    }
